...
$$ {\left( \frac{\hbar^2 (\frac{\pi}2)^2}{2m} - E \right) C(\frac{\pi}2) + \sum_{n} V_n C(\frac{\pi}2 - G_n) = 0} $$

只保留一阶近似，为了求解，保留$ G = \frac{2 \pi}2$项

$$ {\left( \frac{\hbar^2 (\frac{\pi}2)^2}{2m} - E \right) C(\frac{\pi}2) + \sum_{n} V_G C(- \frac{\pi}2) = 0} $$
