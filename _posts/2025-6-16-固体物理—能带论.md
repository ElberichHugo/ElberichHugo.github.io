...
$$
    \left[-\sum_i \frac{\hbar^2}{2m} \nabla_i^2 - \sum_a \frac{\hbar^2}{2M_a} \nabla_a^2 + \frac{1}{2} \sum_{i \neq j} \frac{e^2}{4\pi \varepsilon_0 \varepsilon_r r_{ij}} + V_0(R_1 \cdots R_n) + V(r_1 \cdots r_i \cdots, R_1 \cdots R_a \cdots)\right] \cdot \Psi(r_1 \cdots r_i \cdots, R_1 \cdots R_a \cdots) = E\Psi(r_1 \cdots r_i \cdots, R_1 \cdots R_a \cdots)
